...
if (advisoryDiv) {
  ...
  applyLanguage() {
    // Simple demo translations for main visible text
    const translations = {
      en: {
        'hero-title': 'AgriGuru',
        'hero-subtitle': 'AI-Powered Agricultural Advisory Platform',
        'hero-description': 'Get personalized crop advice, real-time weather alerts, market prices, and sustainable farming practices tailored to your land.',
        'weather-forecast': 'Weather Forecast',
        'crop-recommendations': 'Crop Recommendations',
        'market-prices': 'Market Prices',
        'get-started': 'Get Started',
        'advisoryText': 'Ideal conditions for irrigation today',
        'detailed-analysis': 'Get Detailed Analysis',
        ...
        'empowering': 'Empowering Farmers with AI-Driven Insights',
        'real-time-weather': 'Real-time Weather & Irrigation Tips',
        'crop-yield': 'Crop Yield Forecasts',
        'market-price': 'Market Price Monitoring',
        'personalized-crop': 'Personalized Crop Advisory'
      },
      hi: {
        'hero-title': 'एग्रीगुरु',
        'hero-subtitle': 'एआई-संचालित कृषि सलाह मंच',
        'hero-description': 'अपने खेत के लिए व्यक्तिगत फसल सलाह, मौसम अलर्ट, बाजार मूल्य और टिकाऊ कृषि पद्धतियाँ प्राप्त करें।',
        'weather-forecast': 'मौसम पूर्वानुमान',
        'crop-recommendations': 'फसल सिफारिशें',
        'market-prices': 'बाजार मूल्य',
        'get-started': 'शुरू करें',
        'advisoryText': 'आज सिंचाई के लिए आदर्श स्थिति',
        'detailed-analysis': 'विस्तृत विश्लेषण प्राप्त करें',
        'predict-crop': 'फसल का पूर्वानुमान',
        'view-all-markets': 'सभी बाजार देखें',
        'active-farmers': 'सक्रिय किसान',
        'yield-increase': 'उपज वृद्धि',
        'cost-reduction': 'लागत में कमी',
        'empowering': 'एआई-संचालित अंतर्दृष्टि के साथ किसानों को सशक्त बनाना',
        'real-time-weather': 'रीयल-टाइम मौसम और सिंचाई सुझाव',
        'crop-yield': 'फसल उपज पूर्वानुमान',
        'market-price': 'बाजार मूल्य निगरानी',
        'personalized-crop': 'व्यक्तिगत फसल सलाह'
      },
      bn: {
        'hero-title': 'এগ্রিগুরু',
        'hero-subtitle': 'এআই-চালিত কৃষি পরামর্শ প্ল্যাটফর্ম',
        'hero-description': 'আপনার জমির জন্য ব্যক্তিগত ফসল পরামর্শ, আবহাওয়ার সতর্কতা, বাজার মূল্য এবং টেকসই কৃষি অনুশীলন পান।',
        'weather-forecast': 'আবহাওয়ার পূর্বাভাস',
        'crop-recommendations': 'ফসলের সুপারিশ',
        'market-prices': 'বাজার মূল্য',
        'get-started': 'শুরু করুন',
        'advisoryText': 'আজ সেচের জন্য আদর্শ অবস্থা',
        'detailed-analysis': 'বিস্তারিত বিশ্লেষণ পান',
        'predict-crop': 'ফসল অনুমান করুন',
        'view-all-markets': 'সব বাজার দেখুন',
        'active-farmers': 'সক্রিয় কৃষক',
        'yield-increase': 'ফসল বৃদ্ধি',
        'cost-reduction': 'খরচ হ্রাস',
        'empowering': 'এআই-চালিত অন্তর্দৃষ্টির মাধ্যমে কৃষকদের ক্ষমতায়ন',
        'real-time-weather': 'রিয়েল-টাইম আবহাওয়া ও সেচ পরামর্শ',
        'crop-yield': 'ফসল উৎপাদন পূর্বাভাস',
        'market-price': 'বাজার মূল্য পর্যবেক্ষণ',
        'personalized-crop': 'ব্যক্তিগত ফসল পরামর্শ'
      }
    };
    ...
    if (statLabels.length === 3) {
      statLabels[0].textContent = translations[lang]['active-farmers'];
      statLabels[1].textContent = translations[lang]['yield-increase'];
      statLabels[2].textContent = translations[lang]['cost-reduction'];
    }
    // Weather widget
    const weatherHeader = document.querySelector('.weather-widget .widget-header h2');
    if (weatherHeader) weatherHeader.textContent = translations[lang]['weather-forecast'];
    // Crop widget
    const cropHeader = document.querySelector('.crop-widget .widget-header h2');
    if (cropHeader) cropHeader.textContent = translations[lang]['crop-recommendations'];
    // Market widget
    const marketHeader = document.querySelector('.market-widget .widget-header h2');
    if (marketHeader) marketHeader.textContent = translations[lang]['market-prices'];
    // Buttons
    const getStartedBtn = document.getElementById('startBtn');
    if (getStartedBtn) getStartedBtn.textContent = translations[lang]['get-started'];
    const detailedBtn = document.getElementById('toggleFormBtn');
    if (detailedBtn) detailedBtn.textContent = translations[lang]['detailed-analysis'];
    const predictBtn = document.querySelector('#predict-form button[type="submit"]');
    if (predictBtn) predictBtn.textContent = translations[lang]['predict-crop'];
    const viewAllMarketsBtn = document.querySelector('.market-widget .btn-secondary');
    if (viewAllMarketsBtn) viewAllMarketsBtn.textContent = translations[lang]['view-all-markets'];
    // Advisory
    const advisoryText = document.getElementById('advisoryText');
    if (advisoryText) advisoryText.textContent = translations[lang]['advisoryText'];
    // Intro page
    const introTitle = document.querySelector('.intro-title');
    const introSubtitle = document.querySelector('.intro-subtitle');
    if (introTitle) introTitle.textContent = '🌿 ' + translations[lang]['hero-title'];
    if (introSubtitle) introSubtitle.textContent = translations[lang]['empowering'];
    // Highlights (optional, for demo)
    const highlights = document.querySelectorAll('.intro-highlights li');
    if (highlights.length === 4) {
      highlights[0].textContent = '✅ ' + translations[lang]['real-time-weather'];
      highlights[1].textContent = '📈 ' + translations[lang]['crop-yield'];
      highlights[2].textContent = '💰 ' + translations[lang]['market-price'];
      highlights[3].textContent = '🌾 ' + translations[lang]['personalized-crop'];
    }
  }
